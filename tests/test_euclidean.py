...
class TestVector(unittest.TestCase):
    ...
    def test_construction_and_dimension(self):
        ...
        self.assertEqual(Vector(1, 2, 3).to_tuple(), (1.0, 2.0, 3.0))
        self.assertEqual(Vector([1, 2]).dim, 2)
        self.assertEqual(Vector(np.array([1, 2])).to_tuple(), (1.0, 2.0))
        self.assertEqual(Vector.zero(3).to_tuple(), (0.0, 0.0, 0.0))
...
class TestPoint(unittest.TestCase):
    ...
    def test_construction_and_origin(self):
        ...
        self.assertEqual(Point(1, 2).to_tuple(), (1.0, 2.0))
        self.assertEqual(Point(np.array([1, 2])).to_tuple(), (1.0, 2.0))
        self.assertEqual(Point.origin(2).to_tuple(), (0.0, 0.0))
...
class TestEuclideanChart(unittest.TestCase):
    ...
    def test_domain_and_image_checks(self):
        ...
        chart = EuclideanChart(
            lambda point: point + Vector(1.0, 1.0),
            lambda point: point - Vector(1.0, 1.0),
            source_dim=2,
            target_dim=2,
            domain=domain,
        ...
        self.assertEqual(chart(Point(0.5, 0.25)).to_tuple(), (1.5, 1.25))
        with self.assertRaises(ValueError):
            chart(Point(2.0, 0.0))
        with self.assertRaises(ValueError):
            chart.inverse(Point(3.0, 3.0))
...
class TestEuclideanNeighborhood(unittest.TestCase):
    ...
    def test_box_membership(self):
        ...
        self.assertIn(Point(0.5, 0.0), neighborhood)
        self.assertNotIn(Point(1.5, 0.0), neighborhood)
    ...
    def test_whole_space(self):
        ...
        self.assertIn(Point(-100.0, 1.5), neighborhood)
